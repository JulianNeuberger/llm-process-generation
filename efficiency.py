...
def run_experiments(experiment_type: str, model_name: str, num_iter: int):
    date_formatted = datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
    # copy of pet_md
    if experiment_type == "pet_md":
        directory_path = f"res/efficiency/pet-md/{model_name}/{date_formatted}/"
    ...
    # copy of pet_re
        ...
        directory = f"res/efficiency/pet-re/{model_name}/{date_formatted}/"
        for i in range(num_iter):
            load_dotenv()
            ...
            storage = directory + f"answers/iteration{i}.json"
